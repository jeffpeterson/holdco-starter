---
description: Run the dream cycle in-session — consolidate memory, mine WORKLOG for cross-venture
...
2. **WORKLOG mining** — read the last ~20 `WORKLOG.md` entries; capture any uncaptured durable
   cross-venture / meta-tooling lesson as a new memory file + index line. Skip one-offs.
